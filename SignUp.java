...
public class SignUp {
		public static void main(String[] args) {
			...
			try {
				...
				emailField.sendKeys("aswinee12367@gmail.com");
				...
				driver.findElement(By.xpath("//input[@id='email']")).sendKeys("aswineeK7@gmail.com");
				...
				Thread.sleep(5000);
				String txts = driver.findElement(By.xpath("//h1[contains(text(),'Online Courses')]")).getText();
				// Verify registration (adjust based on actual message)
				if (txts.equals("Online Courses")) {
